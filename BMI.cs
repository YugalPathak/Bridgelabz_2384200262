...
public class BMI
{
    public static void Main()
    {
        ...
        // Call method to process BMI calculation
        ProcessBMI(numberOfPersons);
    }

    // Method to process BMI calculation and display results
    static void ProcessBMI(int numberOfPersons)
    {
