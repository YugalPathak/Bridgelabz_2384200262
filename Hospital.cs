...
internal class Program
{
    public static void Main(string[] args)
    {
        ...
        Patient inpatient = new InPatient("Patient101", "yugal", 25, "Flu", "No prior history", 2000, 3);
        
        // Creating an Out-Patient instance
        Patient outpatient = new OutPatient("Patient102", "kiran", 30, "Cold", "Allergic to penicillin", 500);
