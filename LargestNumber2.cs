...
public class LargestNumber2
{
    public static void Main()
    {
        ...
        // Call method to find and display the largest and second-largest digits
        LargestDigits(number);
    }

    // Method to find and display the largest and second-largest digits
    public static void LargestDigits(int number)
    {
        ...
        while (number != 0)
        {
            if (index == maxDigit)
            {
                ...
                maxDigit += 10;
                int[] temp = new int[maxDigit]; // Created temporary array with increased size
